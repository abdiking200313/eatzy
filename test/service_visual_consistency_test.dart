...
void main() {
  testWidgets('grocery catalog uses green service cards and shared cart action', (
    tester,
  ) async {
  ...
  testWidgets('pharmacy catalog stays overflow-free with the shared cart action', (
    tester,
  ) async {
