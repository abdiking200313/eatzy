...
void main() {
  ...
  SupabaseClient clientWithRole(String userId, String role) {
    final mockClient = MockClient((request) async {
      ...
      if (request.url.path == '/rest/v1/profiles') {
        ...
        return http.Response(jsonEncode({'role': role}), 200, request: request);
      }
  ...
  testWidgets("a customer-role account's sign-in is unchanged: it lands on the "
      'customer home', (tester) async {
