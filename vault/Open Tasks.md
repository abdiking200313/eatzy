...
**Updated 2026-09-24 (board worker, 2nd run), see [[Status Log]] 2026-09-22 for full detail on the last real work.** **Source of truth is always a live `list_issues`/`gh issue list --repo abdiking200313/eatzy --state open` call** — re-check before relying on this for anything that matters.
