...
- `lib/services/` — the "vertical" domains: `food`, `grocery`, `pharmacy` (`cleaning` was removed entirely in issue #50, 2026-08-15 — don't reintroduce it). Fresh Meat and Electronics are **grocery-engine store lists** filtered by `grocery_stores.store_type`, not verticals of their own (2026-09-25)
