...
import 'package:merchant_app/features/orders/presentation/order_detail_screen.dart';
...
/// vocabulary and the terminal state (issue #134's "advance status through
/// the rest of that vertical's vocabulary ... no direct table writes").
void main() {
