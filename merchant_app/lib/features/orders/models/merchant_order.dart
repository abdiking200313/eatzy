...
/// incoming-order queue and fulfillment screens (issue #134). See
/// `merchant_order_vertical.dart`'s header for exactly which migrations each
/// field is verified against.
class MerchantOrder {
  const MerchantOrder({
    required this.id,
