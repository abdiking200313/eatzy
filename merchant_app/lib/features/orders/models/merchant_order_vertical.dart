...
/// Per-vertical order table/column/RPC configuration for issue #134,
/// mirroring how `merchant_vertical.dart` (issue #133) captures per-vertical
/// store/catalog columns rather than forcing one fictitious common shape.
/// This lives in the orders feature (not alongside [MerchantVertical]
/// itself) because issue #134's scope is additive-only and must not touch
/// `lib/features/store/**`.
///
