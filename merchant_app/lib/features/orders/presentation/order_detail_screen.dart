...
/// Order detail view (issue #134): line items, the customer-facing
/// address/contact info already captured on the order, current status, and
/// the accept/reject/advance actions that call `advance_*_order_status`
/// (issue #131) -- no direct table writes.
///
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(MerchantMoney.formatCents(item.lineTotalCents)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(MerchantMoney.formatCents(cents), style: style),
        ],
      ),
    );
  }
