...
/// "Orders" screen (issue #134): the signed-in merchant's incoming-order
/// queue for their own store, newest first, with pull-to-refresh and
/// explicit loading/empty/error states. Reuses [MerchantStoreController]
/// (issue #133) to resolve "my store" instead of re-deriving that logic --
/// a merchant is modeled as owning at most one store, per that issue's own
/// assumption.
      ...
      child: ListTile(
        ...
        trailing: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(MerchantMoney.formatCents(order.totalCents)),
          ],
        ),
      ),
    );
