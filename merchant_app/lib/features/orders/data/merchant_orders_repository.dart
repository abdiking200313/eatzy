...
/// Data access for the signed-in merchant's own orders (issue #134):
/// `food_orders` / `grocery_orders` / `pharmacy_orders`, scoped to the
/// caller's own store via the select policies added in
