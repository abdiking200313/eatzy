...
/// "My Store" screen (issue #133): view and edit the signed-in merchant's
/// own store profile (name, description, address, open/closed, image), or
/// create one if they don't have one yet. Scoped entirely by `owner_id` --
/// see `merchant_store_repository.dart`'s header for the RLS this mirrors.
            ...
            if (vertical.storeSupportsImage) ...[
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Image URL',
                  helperText:
                      'A hosted image link (issue #133 v1 simplification -- '
                      'no in-app image upload yet).',
                  border: OutlineInputBorder(),
                ),
              ),
            ],
