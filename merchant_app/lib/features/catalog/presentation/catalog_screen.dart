...
/// "Catalog" screen (issue #133): list, add, edit, delete, and toggle
/// availability for the merchant's own items in [storeId] -- `menu_items` /
/// `grocery_products` / `pharmacy_products` depending on [vertical]. Order
/// queue/fulfillment screens are out of scope here (issue #134).
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    MerchantMoney.formatCents(item.priceCents),
